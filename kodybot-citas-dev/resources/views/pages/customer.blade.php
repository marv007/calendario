                            ...
                            @csrf
                                <div class="form-body">
                                    ...
                                    <input type="hidden" name="idcustomer" value="{{$customer->idcustomer}}">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">                            
                                               <input type="text"  id="birthday" name="birthday" class="form-control pickadate-months-year"  format="Y-m-d" placeholder="Cumpleaños" value="{{$customer->customer_birthday}}" @if (!$edit): disabled : '' @endif>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <ul class="list-unstyled mb-0" id="status">
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio">
                                                            <input type="radio" name="status" id="active" value="active" @if ($customer->customer_status=='active'): checked : '' @endif @if (!$edit): disabled : '' @endif>
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio">
                                                            <input type="radio" name="status" id="inactive" value="inactive" @if ($customer->customer_status=='inactive'): checked : '' @endif @if (!$edit): disabled : '' @endif>
